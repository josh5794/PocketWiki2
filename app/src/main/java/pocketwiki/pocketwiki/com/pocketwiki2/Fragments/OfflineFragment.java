...
public class OfflineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentView = (RelativeLayout) view.findViewById(R.id.fragmentoffline_parentView);

        String[] alphabetArray = getResources().getStringArray(R.array.alphabets_english);
        ViewPager viewPager1 = (ViewPager) view.findViewById(R.id.fragmentoffline_viewpager1);
        ViewPager viewPager2 = (ViewPager) view.findViewById(R.id.fragmentoffline_viewpager2);
        ...
        //Log.e(TAG,"trimmed size is " + String.valueOf(Utils.trimAlphabetArray(alphabetArray,getActivity(),Config.DATA_TYPE_CITY).length));

        // Give the PagerSlidingTabStrip the ViewPager
        PagerSlidingTabStrip tabsStrip1 = (PagerSlidingTabStrip) view.findViewById(R.id.fragmentoffline_tabs1);
        PagerSlidingTabStrip tabsStrip2 = (PagerSlidingTabStrip) view.findViewById(R.id.fragmentoffline_tabs2);
        // Attach the view pager to the tab strip
        tabsStrip1.setViewPager(viewPager1);
        tabsStrip2.setViewPager(viewPager2);

        cityListLayout = (RelativeLayout) view.findViewById(R.id.fragmentoffline_rlt_city_list);
        categoryListLayout = (RelativeLayout) view.findViewById(R.id.fragmentoffline_rlt_category_list);
        cityListLayout.setVisibility(View.GONE);
        categoryListLayout.setVisibility(View.GONE);

        header1 = view.findViewById(R.id.fragmentoffline_header1);
        header2 = view.findViewById(R.id.fragmentoffline_header2);
